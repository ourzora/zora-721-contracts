...
contract MerkleData {
  ...
  constructor() {
    ...
    testData["test-3-addresses"].root = 0x17fd3b63857e2260948e1b1c1eb2029cbc98e0c78713197225324a234b319cd1;
    ...
    testData["test-3-addresses"].entries.push(MerkleEntry({
    ...
    testData["test-2-prices"].root = 0xb7d8ff9be4b222c3049431d7b5982cbd3e64e5902f0ca4a2e3527be999a12d87;
    
    proof = new bytes32[](1);
    
    proof[0] = bytes32(0xcd1f92f2177fa8f6c51829045204caf23439f3e448bb0b94e5134e5b9f11ea4c);
    
    testData["test-2-prices"].entries.push(MerkleEntry({
      user: 0x0000000000000000000000000000000000000010,
      maxMint: 2,
    ...
    testData["test-max-count"].root = 0xb7d8ff9be4b222c3049431d7b5982cbd3e64e5902f0ca4a2e3527be999a12d87;
    
    proof = new bytes32[](1);
    
    proof[0] = bytes32(0xcd1f92f2177fa8f6c51829045204caf23439f3e448bb0b94e5134e5b9f11ea4c);
    
    testData["test-max-count"].entries.push(MerkleEntry({
      user: 0x0000000000000000000000000000000000000010,
      maxMint: 2,
      mintPrice: 100000000000000000,
      proof: proof 

...
/// @author @iainnash Modifications for tracking ownership virtually with a royalty registry.
abstract contract SplitRegistryNFT {
    /*//////////////////////////////////////////////////////////////
                                 EVENTS
    //////////////////////////////////////////////////////////////*/
    ...
    mapping(address => mapping(address => bool)) public _approvedForAll;
    ...
    function transferFrom(
        ...
        require(from == _getOwner(id), "WRONG_FROM");
    ...
    function _mint(address to, uint256 id) internal virtual {
        ...
        // assume owner is set before calling mint
        // _setOwner(id, to);
    ...
    function _burn(uint256 id) internal virtual {
        ...
        // delete _ownerOf[id];
        // assume owner is set before calling burn

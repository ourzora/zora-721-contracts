...
contract ZoraFeeManagerTest is DSTest {
    ...
    function setUp() public {
        ...
        ZoraFeeManager feeManager = new ZoraFeeManager(500, DEFAULT_ZORA_DAO_ADDRESS);
        vm.prank(DEFAULT_ZORA_DAO_ADDRESS);
    ...
    function test_CreateEdition() public {
        address deployedDrop = creator.createEdition("name", "symbol", 100, 500, DEFAULT_FUNDS_RECIPIENT_ADDRESS, DEFAULT_FUNDS_RECIPIENT_ADDRESS, "desc", "animation", "", "image", "");
    }
}

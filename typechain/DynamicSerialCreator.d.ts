...
interface DynamicSerialCreatorInterface extends ethers.utils.Interface {
  functions: {
...
export class DynamicSerialCreator extends Contract {
  ...
  interface: DynamicSerialCreatorInterface;

...
interface SharedEditionsMintableInterface extends ethers.utils.Interface {
  functions: {
    ...
    "setAllowedCreator(address)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "setAllowedCreator",
    values: [string]
  ): string;
  encodeFunctionData(
...
export class SharedEditionsMintable extends Contract {
  ...
  interface: SharedEditionsMintableInterface;
